...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            ...
            <table class="table table-bordered table-sm table-striped table-hover">
                ...
                <tr>
                    <td>Status obrade</td>
                    <td class="{{$order->status->name == 'izdat'?'text-danger':''}}"><strong >{{$order->status->name}}</strong> <small>ažuriran
    ...
    <div class="row">
        @if(!($order->status()->first()->name == 'izdat'))
        <div class="col-md-3">
            {{-- EDIT --}}
            <a href="{{route('orders.edit',$order)}}"><button class="alert btn btn-primary btn-block">Izmeni</button></a>
        </div>
